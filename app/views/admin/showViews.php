...
<body>
    ...
    <div id="adminContent" class="adminContent">
        ...
        <div class="selectTab">
            <div class="searchBoxContainer">
    			...
    			placeholder="Search Views Based On Date..." class="search" autocomplete="off" />
			</div>
			
			<div class="descForViews">
			    <div>Distinct People : </div>
			    <div id="distinct_people"></div>
			</div>
    ...
    <script src="/js/admin/showViews.js"></script>

...
//15324
//send to user when basket processed
function send_sms15324($phone,$price){
	try {
...
//14841
//send to admin when user buy a basket
function send_sms14841($phone,$price){
	try {
...
//15276
//send to admin when user buy a basket
function send_sms15276($phone,$price){
	try {
...
//send for verification code
function send_sms13671($phone,$sms){
	try {
...
function phoneSanitize($phone){
	...
	$isThatStartsWith = startsWith($phone , $startsWith);
	if( $isThatStartsWith === true ){

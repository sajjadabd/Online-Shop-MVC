...
$selectAttack = "SELECT * FROM blocked WHERE ip_address='$ip_address' LIMIT 1";
...
if($selectAttackRes === false){
    ...
    if($attack_before > 0) {
        ...
        if($hacker_attack >= 5){
            ...
            $differ = calculateMinutes($from_date,$to_date);
            $minutes = $differ;
            $minutes = 60 - $minutes;
            ...
            if( $minutes <= 60 && $minutes > 0 ) {
                ...
                $setAttackZero = "UPDATE blocked SET hacker_attack='0',date='$to_date' WHERE ip_address='$ip_address'";
